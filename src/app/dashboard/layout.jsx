        ...
        >
          <div className="flex border-t border-b-2 py-4 mb-6">
            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex gap-1">
                <span className="text-xs uppercase rounded-full px-2 bg-blue-400 text-white">
                  {users?.role}
                </span>
                <span className="text-xs uppercase rounded-full px-2 bg-green-400 text-white">
                  {users?.classes}
                </span>
              </div>
            </div>
          ...
          <div className="w-full hidden md:flex flex-col gap-4 px-2">
            {session?.user?.role === "admin" && (
              <Link
                className="px-4 flex gap-2 items-center text-blue-500 hover:text-gray-600"
            ...
            <button
              onClick={() => signOut()}
              className="px-4 text-sm flex gap-2 items-center text-blue-500 hover:text-gray-600"
            >
              <IoMdLogOut size={22} />
              <span>Logout</span>
            </button>
