  ...
  return (
    <>
      ...
      <div className='w-full  bg-blue-400 px-4 md:px-20 py-6'>
        <div className=' flex'>
          <Image src="/icb-putih.png" width={100} height={100} />
      ...
      <div className="w-full px-4">
        <div className='max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl p-8 md:p-14 relative top-0 md:-top-8'>
          ...
          <form className="flex flex-col gap-4 ">
            ...
            <button className="px-6 py-3 text-white uppercase transition-all duration-150 ease-linear bg-gradient-to-tr from-green-500 to-lime-400 rounded-full hover:bg-green-500">
