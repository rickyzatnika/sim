        ...
        {infos?.map((info, i) => (
          ...
          >
            ...
            <div className="flex-1 shadow-sm">
              <div className="flex items-center justify-between bg-orange-200/50 p-2 rounded-md text-gray-600">
              ...
              <p className="px-3 py-5 text-sm">{info?.desc}</p>
            </div>
          </Link>
        ))}
      </div>
        ...
        <form onSubmit={handleSubmit} className="mt-6">
          <div className="flex flex-col">
            ...
            <input
              ...
              value={kodePeserta}
              disabled
              className="p-2 cursor-not-allowed outline-none rounded-lg text-gray-500 bg-white"
            />
          </div>
          <div className="flex flex-col">
            ...
            <input
              ...
              type="text"
              className="p-2 text-gray-500  outline-none focus:border-2 rounded-lg focus:border-blue-500"
            />
          </div>
          <div className="flex flex-col">
